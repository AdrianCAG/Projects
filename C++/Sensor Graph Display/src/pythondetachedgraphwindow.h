#ifndef PYTHONDETACHEDGRAPHWINDOW_H
#define PYTHONDETACHEDGRAPHWINDOW_H
...
class PythonDetachedGraphWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit PythonDetachedGraphWindow(QWidget *parent = nullptr);
    ~PythonDetachedGraphWindow();
...
#endif // PYTHONDETACHEDGRAPHWINDOW_H
