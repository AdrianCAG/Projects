...
parser.add_argument('--preload', action='store_true', help='Keep Python running and matplotlib loaded in memory')
...
if __name__ == "__main__":
    try:
        ...
        # Handle preload mode - just keep matplotlib loaded and wait
        if args.preload:
            print("Python chart backend ready")
            # Keep the process alive for an hour
            time.sleep(3600)
            sys.exit(0)
